...
describe("Test Suite Get Payment Group", function () {
   before(async function () {
      await initial.Login_Yoshinoya();
   });

   it("Get Payment Group should be success #20230806020700", async function () {
      let response = await api_general.GetPaymentGroup();

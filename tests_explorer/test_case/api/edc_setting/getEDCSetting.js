...
describe("Test Suite GET EDC Setting", function () {
   before(async function () {
      await initial.Login_Yoshinoya();
   });

   it("Get EDC Setting should be success #20230806020700", async function () {
      let response = await api_general.GetEDCSetting();

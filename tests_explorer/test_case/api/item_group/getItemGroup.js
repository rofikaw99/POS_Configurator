...
describe("Test Suite GET Item Group", function () {
   before(async function () {
      await initial.Login_Yoshinoya();
   });

   it("Get Item Group should be success #20230806020700", async function () {
      let response = await api_general.GetItemGroup();

...
describe("Test Suite Get Combo Definition", function () {
   before(async function () {
      await initial.Login_Yoshinoya();
   });

   it("Get Combo Definition should be success #20230806020700", async function () {
      let response = await api_general.GetComboDefinition();
